  ...
  return (
    <div className="bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-12">
        ...
        {/* Hero / Banner Section */}
        <section className="relative overflow-hidden rounded-2xl bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-sm">
          <div className="px-8 py-14 md:px-12 md:py-20 text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white">
              Discover <span className="text-gray-700 dark:text-gray-400">Campus Events</span>
            </h1>
