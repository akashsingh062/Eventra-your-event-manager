  ...
  return (
    <div className="bg-transparent">
      ...
      <div className="max-w-7xl mx-auto px-6 py-10 space-y-10">
        ...
        {/* Page Heading */}
        <section className="relative overflow-hidden rounded-3xl bg-linear-to-br from-emerald-900 via-teal-900 to-emerald-800 shadow-xl">
          {/* Decorative elements */}
          <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
            ...
            <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-emerald-500 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
          </div>
          ...
          <div className="relative z-10 px-8 py-16 text-center max-w-3xl mx-auto flex flex-col items-center">
            <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4 drop-shadow-sm">
              My <span className="text-transparent bg-clip-text bg-linear-to-r from-teal-400 to-emerald-300">Registrations</span>
            </h1>
            <p className="text-lg text-emerald-100 max-w-xl font-light">
        ...
        <div className="w-full">
          {loading ? (
            ...
            <div className="text-center bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl py-24 shadow-sm max-w-2xl mx-auto">
              <div className="text-teal-500/50 mb-6 flex justify-center">
              ...
              <a href="/events" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-full text-teal-900 bg-teal-100 hover:bg-teal-200 transition-colors">
                Browse Events
              </a>
            </div>
          )}
